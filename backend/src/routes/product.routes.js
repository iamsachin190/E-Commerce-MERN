...
import { uploadSingle , uploadSingleFile } from "../middlewares/multer.middleware.js";


const productRouter = Router();

productRouter.post('/create',verifyJWT, uploadSingle , uploadSingleFile , createProduct);
